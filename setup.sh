...
# Header
_sep
echo "Setup ML4W Dotfiles Sidebar"
...
wget -q -P "$HOME/.cache" "https://github.com/mylinuxforwork/dotfiles-sidebar/releases/latest/download/com.ml4w.sidebar.flatpak"
cd "$HOME/.cache"
echo ":: Installing com.ml4w.sidebar.flatpak"
eval "flatpak --user -y --reinstall install com.ml4w.sidebar.flatpak > $cmdoutput"
rm "$HOME/.cache/com.ml4w.sidebar.flatpak"
